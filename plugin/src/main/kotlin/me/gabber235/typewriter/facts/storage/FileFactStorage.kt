...
private suspend fun migrateFacts(storage: FactStorage) {
    ...
    val facts = directory.listFiles()?.flatMap { file ->
        ...
        facts.map { oldFact ->
            ...
            val data = FactData(oldFact.numValue, oldFact.strValue, oldFact.lastUpdate)
...
private data class OldFact(val id: String, val numValue: Int, val strValue: String, val lastUpdate: LocalDateTime)
